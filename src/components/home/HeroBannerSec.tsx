...
import banner1 from '../../../public/assets/img/slider-img/computers.webp';
import banner2 from '../../../public/assets/img/slider-img/software.webp';
  ...
  const sliderData = [
    {
      ...
      bgImg: banner1,
      tagOne: 'Hardware',
      tagTwo: 'Massive Collection of Computers',
    },
    {
      id: 2,
      bgImg: banner2,
      tagOne: 'Software',
      tagTwo: 'Apps For all professions',
    },
    // {
    //   id: 3,
    //   bgImg: banner3,
